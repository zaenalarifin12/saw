                                        ...
                                        <form id="kt_modal_add_user_form" class="form" action="{{ url("/hp") }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                ...
                                                <div class="mb-7">
                                                    ...
                                                    <input type="time" name="jam_buka" required class="form-control form-control-solid mb-3 mb-lg-0" />
                                                </div>
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    ...
                                    <form method="POST" action="{{ url("/hp/$item->id") }}" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Internal</label>
                                                <input type="number" name="internal" required value="{{ $item->jam_buka }}" class="form-control form-control-solid mb-3 mb-lg-0" />
                                            </div>


                                            <div class="mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Kamera</label>
                                                <input type="number" name="kamera" required value="{{ $item->jam_tutup }}" class="form-control form-control-solid mb-3 mb-lg-0" />
                                            </div>


                                            <div class="mb-7">
                                                <label class="required fw-bold fs-6 mb-2">Ram</label>
                                                <input type="number" name="ram" required value="{{ $item->lat }}" class="form-control form-control-solid mb-3 mb-lg-0" />
                                            </div>
