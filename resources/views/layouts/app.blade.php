							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
								...
								<div class="menu-item">
									<a class="menu-link" href="{{ url("/hp") }}">
										...
										<span class="menu-title"> Daftar HP</span>
									</a>
								</div>
								...
								<div class="menu-item">
									<a class="menu-link" href="{{ url("/compare") }}">
										...
										<span class="menu-title"> Compare HP</span>
									</a>
								</div>
						...
						@if(session()->has('message'))
							<div class="alert alert-dismissible bg-light-primary border border-primary d-flex flex-column flex-sm-row p-5 mb-10">
								<div class="d-flex flex-column pe-0 pe-sm-10">
									<h5 class="mb-1">{{ session()->get('message') }}</h5>
								</div>
